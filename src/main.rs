...
const TOTAL_MINERS: usize = 5;
const N_REGIONS: usize = 5;
const LEADER_ID: usize = TOTAL_MINERS + 1;
...
fn main() {
    ...
    leader_loop(leader_rx, &mut senders, condvar_listen, condvar_transfer);
...
fn give_orders(senders: &HashMap<usize, Sender<Message>>, command: Commands) {
